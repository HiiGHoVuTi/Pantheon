...
in
{
  ...
  programs.spicetify = {
    ...
    theme = config.pantheon.theming.get themeMap;
    colorScheme = config.pantheon.theming.get colorschemeMap;
  ...
  # {{{ Persistence
  # pantheon.persistence.at.state.apps.spotify.directories = [
  #   "${config.xdg.configHome}/spotify"
  # ];

  # pantheon.persistence.at.cache.apps.spotify.directories = [
